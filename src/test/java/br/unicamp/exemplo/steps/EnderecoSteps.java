...
public class EnderecoSteps {
    ...
    public void setUp() {
    	// n√£o precisa desse Mock aqui.. mas s√≥ para deixar de exemplo de como faz.. vamos usar no calculo de frete
    ...
    public void o_sistema_faz_a_busca_do_endereco_nos_correios() throws Throwable {
		...
		stubFor(get(urlEqualTo("/viacep/ws/01001000/json/"))
		        ...
		        .withBody("{\"cep\": \"01001-000\", \"logradouro\": \"PraÁa da SÈ\", \"complemento\": \"lado Ìmpar\", \"bairro\": \"SÈ\", \"localidade\": \"S„o Paulo\", \"uf\": \"SP\", \"ibge\": \"3550308\"}")));
		endereco.buscar();
    	} catch(Throwable t){
    		throwable = t;
    	}
    ...
    // fazer um teste passando um CEP invalido e lan√ßa a classe CEPInvalidoException 
