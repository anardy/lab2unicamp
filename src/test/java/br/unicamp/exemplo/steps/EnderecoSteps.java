...
public class EnderecoSteps {
    ...
    public void o_cep_do_usuario_e_conhecido_pelo_sistema(String arg1) throws Throwable {
    	...
    	stubFor(get(WireMock.urlMatching("/viacep/ws/.*/json/"))
		        ...
		        .withBody("{\"cep\": \"01001-000\", \"logradouro\": \"Praa da SŽ\", \"complemento\": \"lado ’mpar\", \"bairro\": \"SŽ\", \"localidade\": \"S‹o Paulo\", \"uf\": \"SP\", \"ibge\": \"3550308\"}")));
    	} catch(Throwable t){
    		throwable = t;
    	}
    }
    
    @Dado("^O CEP do usuario nao Ž conhecido pelo sistema$")
    public void o_CEP_do_usuario_nao_Ž_conhecido_pelo_sistema(String arg1) throws Throwable {
    	try{
    	stubFor(get(WireMock.urlMatching("/viacep/ws/.*/json/"))
		        .willReturn(aResponse()
		        .withHeader("Content-Type", "application/json")
...
public class EnderecoSteps {
    ...
    public void o_cep_do_usuario_e_conhecido_pelo_sistema(String arg1) throws Throwable {
    	...
    	stubFor(get(WireMock.urlMatching("/viacep/ws/.*/json/"))
		        .willReturn(aResponse()
		        .withHeader("Content-Type", "application/json")
		        .withBody("{\"cep\": \"01001-000\", \"logradouro\": \"PraÃ§a da SÃ©\", \"complemento\": \"lado Ã­mpar\", \"bairro\": \"SÃ©\", \"localidade\": \"SÃ£o Paulo\", \"uf\": \"SP\", \"ibge\": \"3550308\"}")));
    	} catch(Throwable t){
    		throwable = t;
    	}
    }
    
    @Dado("^O CEP do usuario nao Ã© conhecido pelo sistema$")
    public void o_CEP_do_usuario_nao_Ã©_conhecido_pelo_sistema(String arg1) throws Throwable {
    	try{
    	stubFor(get(WireMock.urlMatching("/viacep/ws/.*/json/"))
		        .willReturn(aResponse()
		        .withHeader("Content-Type", "application/json")
...
>>>>>>> 92cf83e3091b6e1272e065316fc2aa1061903800
}